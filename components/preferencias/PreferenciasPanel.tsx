...
import type { NavDensidad, Tema, TamanoLetra } from "@/lib/preferencias";
...
export function PreferenciasPanel({
  ...
  const { tema, setTema, tamanoLetra, setTamanoLetra, navDensidad, setNavDensidad } = usePreferencias();
