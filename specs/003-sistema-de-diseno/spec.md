...
- Menú de navegación con tres modos de densidad seleccionables por el usuario (hamburguesa / iconos / visible), con un default razonable por tamaño de pantalla y posibilidad de cambiarlo manualmente en cualquiera.
...
- Panel de configuración de lectura con tamaño de letra ajustable en v1, modelado de forma extensible para futuros controles de lectura (interlineado, ancho de columna, etc.).
- Diferenciación visual y navegación (pestañas o anclas) entre texto oficial / material adaptado / resumen dentro de la vista de un concepto.
- Rediseño del estado "contenido pendiente de redactar" ya existente, conservando el lenguaje de borde discontinuo.
...
- Rediseño de los badges de núcleo común y bookmark con contraste correcto en ambos temas.
...
- Offline / PWA.
- Accesibilidad más allá de contraste de color y estructura de navegación (p. ej. soporte completo de lector de pantalla, navegación por teclado exhaustiva) — no descartado a futuro, pero no es el foco de esta iteración.
...
- [ ] El menú de navegación ofrece tres modos de densidad (hamburguesa, iconos, visible) con un default razonable por tamaño de pantalla, y el usuario puede cambiar de modo manualmente en cualquier tamaño de pantalla.
